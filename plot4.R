...
# plot 4
par(mfrow = c(2,2))
plot(data$time, data$Global_active_power, col = "green", xlab = "", ylab = "Global Active Power", type = "l")
plot(data$time, data$Voltage, col = "orange", xlab = "datetime", ylab = "Voltage", type = "l")
...
plot(data$time, data$Global_reactive_power, col = "blue", xlab = "datetime", ylab = "Global_reactive_power", type = "l")